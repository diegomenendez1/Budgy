...
- [ ] **Validación de IA**: Si el script usa IA, se ha verificado que use `gpt-5-mini`.
- [ ] **Validación de Esquema**: Las respuestas JSON de la IA pasan por una validación de tipo (ej. Zod).
